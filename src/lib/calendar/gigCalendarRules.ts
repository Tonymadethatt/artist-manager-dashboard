...
export function dealQualifiesForCalendar(
  deal: Pick<Deal, 'venue_id' | 'event_start_at' | 'event_end_at'>,
...
export function calendarQualificationFirstTouch(args: {
  before: Pick<Deal, 'venue_id' | 'event_start_at' | 'event_end_at'>
  after: Pick<Deal, 'venue_id' | 'event_start_at' | 'event_end_at'>
