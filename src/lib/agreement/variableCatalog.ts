...
export const AGREEMENT_VARIABLE_CATALOG: VariableCatalogEntry[] = [
  ...
  { key: 'venue_type', label: 'Entity type (slug)', group: 'venue' },
  { key: 'venue_type_label', label: 'Entity type (label)', group: 'venue' },
  ...
  { key: 'deposit_due_display', label: 'Scheduled deposit due (snapshot or deal column), whole USD', group: 'deal' },
  { key: 'deposit_paid_display', label: 'Deposit paid toward contract (whole USD)', group: 'deal' },
  { key: 'balance_paid_display', label: 'Balance / remainder paid (whole USD)', group: 'deal' },
  { key: 'total_paid_display', label: 'Deposit + balance paid (whole USD)', group: 'deal' },
  {
    key: 'payment_status_plain',
    label: 'Payment state (plain English: deposit, partial, balance due, settled)',
    group: 'deal',
  },
  { key: 'deposit_satisfied_plain', label: 'Deposit satisfied: yes or no', group: 'deal' },
  { key: 'fully_settled_plain', label: 'Artist fully settled flag: yes or no (Earnings “Done”)', group: 'deal' },
